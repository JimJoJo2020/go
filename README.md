...
- [conditional-batch-executor](https://github.com/plzzzzg/conditional-batch-executor) - A batch executor that collects tasks and executes them when conditions are met for Go.
