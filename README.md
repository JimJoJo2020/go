...
- [gno](https://github.com/gnolang/gno) - Comprehensive smart contract suite based on Golang and Gnolang, a purpose-built, deterministic interpreted Go variant for blockchains.
